return {
  {
    ...
    config = function()
      ...
      null_ls.setup({
        ...
        sources = {
          -- No needing to install this
          null_ls.builtins.code_actions.shellcheck,      -- https://www.shellcheck.net/
          null_ls.builtins.code_actions.gomodifytags,    -- https://github.com/jose-elias-alvarez/null-ls.nvim/blob/main/lua/null-ls/builtins/code_actions/gomodifytags.lua
